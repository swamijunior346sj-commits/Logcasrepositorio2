...
const EliteInvoiceSuccess: React.FC<EliteInvoiceSuccessProps> = ({
    ...
    useEffect(() => {
        // Simulates document processing/loading for 3 seconds
    ...
    return (
        <div className="flex justify-center items-start min-h-screen bg-pitch-black overflow-hidden font-sans" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
            ...
            {isLoading ? (
                        ...
                        <div className="pdf-document w-full rounded-sm p-6 flex flex-col border border-white/5 blur-[4px]">
                            <div className="flex justify-between items-start mb-6">
                                ...
                                <div className="text-right">
                                    <h1 className="text-[10px] font-black tracking-widest text-white uppercase opacity-80">EXTRATO OFICIAL DE</h1>
                                    <h1 className="text-[10px] font-black tracking-widest text-white uppercase opacity-80">PRESTAÇÃO DE SERVIÇOS</h1>
                                </div>
                            </div>
                ...
                <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden max-w-[430px] bg-pitch-black shadow-2xl pb-10 animate-in fade-in duration-500">
                    <div className="flex items-center justify-center p-6 mt-4 relative h-10">
                    </div>
                    ...
                    <div className="px-4 relative blur-xl select-none pointer-events-none opacity-40">
                        ...
                        <div className="w-full pt-8 flex flex-col items-center gap-6">
                            <div className="w-full bg-transparent border border-[#EBC051]/30 h-14 rounded-[20px]"></div>
                            <div className="flex items-center justify-center gap-8 opacity-10">
                                <div className="size-14 rounded-full border border-white/10 bg-white/5"></div>
                                <div className="size-14 rounded-full border border-white/10 bg-white/5"></div>
                                <div className="size-14 rounded-full border border-white/10 bg-white/5"></div>
                            </div>
                        </div>
                    ...
                    <div className="absolute inset-0 z-50 flex items-center justify-center px-6">
                        <div className="minimal-gold-border w-full max-w-[340px] rounded-[32px] p-12 flex flex-col items-center relative overflow-hidden bg-black/60 backdrop-blur-sm">
                            ...
                            <button onClick={onViewInvoice} className="minimal-gold-button w-full py-5 rounded-[22px] text-[#EBC051] font-extrabold text-[12px] uppercase tracking-[0.5em] transition-all active:scale-[0.98] hover:bg-[#EBC051]/[0.03]">
                                ABRIR ARQUIVO
                            </button>
                        </div>
                    </div>
