...
const LuxuryConfirmModal: React.FC<LuxuryConfirmModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[1000] flex min-h-screen w-full flex-col items-center justify-center p-6 bg-pitch-black/80 backdrop-blur-sm animate-in fade-in duration-300">
