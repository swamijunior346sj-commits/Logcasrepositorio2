...
const EliteSettings: React.FC<EliteSettingsProps> = ({ onBack, onLogout }) => {
    return (
        <div className="flex flex-col items-center bg-pitch-black animate-in fade-in duration-700 pb-10">
      ...
      `}} />
            ...
            <div className="relative flex w-full flex-col overflow-x-hidden max-w-[430px] bg-pitch-black shadow-2xl ring-1 ring-white/5">
