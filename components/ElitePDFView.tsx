...
const ElitePDFView: React.FC<ElitePDFViewProps> = ({ logs, userName, onBack }) => {
    useEffect(() => {
        ...
        document.title = "Relatório Detalhado Minimalista Absoluto";
        return () => { document.title = prevTitle; };
    }, []);


    // Processar logs para o grid
            ...
            <div className="relative flex w-full flex-col max-w-[430px] pdf-container">
                <div className="flex flex-col bg-charcoal border border-primary-gold/20 rounded-2xl cinematic-glow overflow-hidden">
                    ...
                    <div className="px-6 py-10 flex flex-col items-center gap-2 border-b border-primary-gold/10">
                        ...
                        <h1 className="text-[16px] font-bold tracking-[0.5em] gold-gradient-text uppercase text-center font-sans">RELATÓRIO OPERACIONAL</h1>
                        <p className="text-[9px] text-white/30 tracking-widest uppercase">Extrato Detalhado de Movimentação</p>
                    </div>
