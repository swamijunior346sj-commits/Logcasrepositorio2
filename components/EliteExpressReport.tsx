...
const EliteExpressReport: React.FC<EliteExpressReportProps> = ({ userName, onBack, onExportPDF, onViewPDF, valorPorPacote }) => {
    ...
    const saveEdit = (id: string) => {
        ...
        setRows(rows.map(r => r.id === id ? {
            ...
            totalValue: deliveredCount * valorPorPacote
        } : r));
        setEditingId(null);
    };
