                            ...
                            {routeData.length > 0 ? (
                                routeData.slice(0, 6).map((route, idx) => (
                                    <React.Fragment key={idx}>
                                        ...
                                        {/* Cockpit Menu Integration (Inline Expansion) */}
                                        {selectedRow === idx && !deletingRow && (
                                            <div className="w-full flex justify-center gap-12 py-5 my-2 bg-[#050505] border border-[#EBC051]/20 rounded-3xl shadow-[0_10px_30px_rgba(0,0,0,0.8)] animate-in slide-in-from-top-4 fade-in duration-300">
                                                <button
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                                    ...
                                                    className="flex flex-col items-center gap-2 group/btn active:scale-90 transition-transform"
                                                >
                                                    <div className="size-12 rounded-full flex items-center justify-center bg-blue-500/10 border border-blue-500/30">
                                                        <span className="material-symbols-outlined text-blue-500 text-xl">edit</span>
                                                    </div>
                                                ...
                                                <button
                                                    ...
                                                    className="flex flex-col items-center gap-2 group/btn active:scale-90 transition-transform"
                                                >
                                                    <div className="size-12 rounded-full flex items-center justify-center bg-red-500/10 border border-red-500/30">
